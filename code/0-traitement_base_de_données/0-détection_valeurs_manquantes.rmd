...
```
On remarque que les données avec le plus de données manquantes sont celles qui ont un lien avec l'alimentation, il existe peut-être une corrélation (A mettre en evidance ???).
