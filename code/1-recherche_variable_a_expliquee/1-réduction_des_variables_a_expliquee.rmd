...
png("acp_rep_cluster_var_orig.png", height = 800, width = 1450)
par(mar=c(6.5,12.5,3,3), lwd=3, mgp = c(5, 1, 0))

boxplot(value ~ rep(pca_data$Cluster, each = 4) * X2, data = meltData,
        horizontal =  TRUE,           
        outline = FALSE,  
        col = colors,  
        frame = FALSE,
